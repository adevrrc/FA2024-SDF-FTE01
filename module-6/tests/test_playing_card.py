...
class TestPlayingCard(unittest.TestCase):
    ...
    def test_init_initialize_a_playing_card(self):
        ...
        # WRONG:
        #self.assertEqual(expected_rank, card.__rank)
    ...
    def test_suit_returns_the_current_state(self):
        # Arrange
        rank = Rank.JACK
        suit = Suit.CLUB
        card = PlayingCard(rank, suit)
    ...
    def test_suit_raises_TypeError_suit_is_not_a_Suit(self):
        # Arrange
        rank = Rank.JACK
        suit = Suit.CLUB
        card = PlayingCard(rank, suit)
    ...
    def test_suit_modify_the_current_state(self):
        # Arrange
        rank = Rank.JACK
        suit = Suit.CLUB
        card = PlayingCard(rank, suit)
    ...
    def test_flip_updates_to_be_face_up(self):
        # Arrange
        rank = Rank.JACK
        suit = Suit.CLUB
        card = PlayingCard(rank, suit)
    ...
    def test_flip_updates_to_be_face_down(self):
        # Arrange
        rank = Rank.JACK
        suit = Suit.CLUB
        card = PlayingCard(rank, suit)
    ...
    def test_repr_returns_string_representation(self):
        ...
        # Assert
        expected = "PlayingCard(rank=Rank.JACK, suit=Suit.CLUB)"
        self.assertEqual(expected, actual)
